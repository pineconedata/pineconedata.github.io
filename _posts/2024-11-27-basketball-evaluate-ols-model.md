...
This article uses the trained models and test-set outputs from [Part 7](/2024-09-13-basketball-train-ols/).

For this article, we'll use:

- [joblib](https://joblib.readthedocs.io/en/stable/) - loading trained models
- [pandas](https://pandas.pydata.org/docs/) - loading saved test datasets and prediction outputs
- [NumPy](https://numpy.org/doc/) - numerical calculations
- [scikit-learn](https://scikit-learn.org/stable/) - regression metrics
- [matplotlib](https://matplotlib.org/) - diagnostic plots
- [seaborn](https://seaborn.pydata.org/) - residual plots and visual comparisons
